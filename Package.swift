...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/TICESoftware/TICE-SwiftModels.git", Version(49,0,0)..<Version(50,0,0)), 
        ...
        .package(url: "https://github.com/TICESoftware/X3DH.git", from: "2.0.7"),
        .package(url: "https://github.com/TICESoftware/DoubleRatchet.git", from: "2.0.0"),
